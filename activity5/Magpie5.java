...
public class Magpie5 
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "no") >= 0)
        {
            ...
            response = "I had three different wives throughout my life, Cornelia, Pompeia, and Calpurnia.";

        else if (findKeyword(statement, "Did you have any children?", 0) >= 0)
            response = "I had three children.";

        else if (findKeyword(statement, "What are their names?", 0) >= 0)
            response = "Julia, Augustus, and Caesarion.";

        else if (findKeyword(statement, "Where were you born?", 0) >= 0)
            response = "I was born in Suburra, Italy.";

        else if (findKeyword(statement, "Where did you live?", 0) >= 0)
            response = "I lived in Rome while I ruled the kingdom.";

        else if (findKeyword(statement, "old", 0) >= 0)
            response = "I was 55 years old at the time of my passing.";
